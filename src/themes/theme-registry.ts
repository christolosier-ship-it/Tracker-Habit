...
const makeTheme = (theme: AppTheme) => theme;
...
export const themes: AppTheme[] = [
  ...
  makeTheme({
    ...
    tokens: {
      background: "#FFF8E8",
      backgroundAlt: "#FFE6B2",
      surface: "#FFFFFF",
      surfaceSoft: "#FFF1CC",
      surfaceStrong: "#FFD60A",
      text: "#111111",
      textMuted: "#4B4B4B",
      primary: "#FF3B30",
      primarySoft: "#FFD7D4",
    ...
    charts: makeCharts({
      ...
      visual: {
        ...
        donutVariant: "solid",
        barVariant: "comic",
        heatmapVariant: "memphis-shapes",
      },
    }),
    radius: { card: "18px", button: "8px", pill: "999px" },
    effects: {
      backgroundStyle: "memphis",
      glass: false,
      glow: false,
      pattern: true,
      stickers: false,
  ...
  makeTheme({
    ...
    tokens: {
      ...
      textMuted: "#D8D3F7",
      primary: "#A78BFA",
      primarySoft: "rgba(167,139,250,.22)",
      secondary: "#67E8F9",
      accent: "#F9A8D4",
      accent2: "#C4B5FD",
      success: "#5EEAD4",
  ...
  makeTheme({
    ...
    tokens: {
      background: "#FFF3C7",
      backgroundAlt: "#DDF8D8",
      surface: "#FFFBEA",
      surfaceSoft: "#E9F9D8",
      surfaceStrong: "#FFB703",
      text: "#104235",
      textMuted: "#487466",
      primary: "#087F5B",
      primarySoft: "#B7E4C7",
  ...
  makeTheme({
    ...
    tokens: {
      background: "#12071F",
      backgroundAlt: "#260A44",
      surface: "#1B0B35",
      surfaceSoft: "#2A1155",
      surfaceStrong: "#3B1680",
      text: "#F7ECFF",
      textMuted: "#BDA5D6",
      primary: "#FF2BD6",
      primarySoft: "rgba(255,43,214,.18)",
      secondary: "#00F5D4",
      accent: "#FEE440",
      accent2: "#9B5DE5",
      success: "#00FF85",
    ...
    charts: makeCharts({
      ...
      visual: {
        ...
        donutVariant: "pixel",
        barVariant: "pixel",
        heatmapVariant: "pixel-blocks",
      },
    }),
    radius: { card: "10px", button: "6px", pill: "4px" },
    effects: {
      backgroundStyle: "arcade",
      glass: false,
      glow: true,
      pattern: true,
      stickers: false,
  ...
  makeTheme({
    ...
    tokens: {
      background: "#08051A",
      backgroundAlt: "#1B0D3A",
      surface: "#130C2E",
      surfaceSoft: "#211449",
      surfaceStrong: "#2E1B68",
      text: "#F4EEFF",
      textMuted: "#C9B9E8",
      primary: "#8B5CF6",
      primarySoft: "rgba(139,92,246,.18)",
      secondary: "#EC4899",
      accent: "#22D3EE",
      accent2: "#F472B6",
      success: "#A3E635",
  ...
  makeTheme({
    ...
    tokens: {
      background: "#FFF0FA",
      backgroundAlt: "#E9F8FF",
      surface: "#FFFFFF",
      surfaceSoft: "#FFF7FD",
      surfaceStrong: "#FFD6E8",
      text: "#5B345B",
      textMuted: "#9B6F9B",
      primary: "#FF8ACD",
      primarySoft: "#FFD6E8",
    ...
    charts: makeCharts({
      ...
      visual: {
        ...
        donutVariant: "soft",
        barVariant: "rounded",
        heatmapVariant: "kawaii-stickers",
      },
    }),
    radius: { card: "32px", button: "999px", pill: "999px" },
    effects: {
      backgroundStyle: "kawaii",
      glass: false,
      glow: false,
      pattern: true,
      stickers: true,
  ...
  makeTheme({
    ...
    tokens: {
      ...
      surface: "#111111",
      surfaceSoft: "#1A1A1A",
      surfaceStrong: "#FF0A7A",
      text: "#FFFFFF",
      textMuted: "#D0D0D0",
      primary: "#FF0A7A",
      primarySoft: "rgba(255,10,122,.22)",
      secondary: "#0057FF",
      accent: "#F9FF00",
      accent2: "#00FF94",
      success: "#00FF94",
    ...
    charts: makeCharts({
      ...
      visual: {
        ...
        donutVariant: "solid",
        barVariant: "block",
        heatmapVariant: "brutalist-blocks",
      },
    }),
    radius: { card: "0px", button: "0px", pill: "0px" },
    effects: {
      backgroundStyle: "brutalist",
      glass: false,
      glow: false,
      pattern: true,
      stickers: false,
  ...
  makeTheme({
    ...
    tokens: {
      background: "#090806",
      backgroundAlt: "#17130D",
      surface: "#15120E",
      surfaceSoft: "#201A12",
      surfaceStrong: "#2A210F",
      text: "#F8EFD9",
      textMuted: "#BDAF8C",
      primary: "#C9A227",
      primarySoft: "rgba(201,162,39,.18)",
      secondary: "#846A2D",
      accent: "#F5D76E",
      accent2: "#FFFFFF",
      success: "#D6B85A",
  ...
  makeTheme({
    ...
    tokens: {
      background: "#FFE8D6",
      backgroundAlt: "#FFD500",
      surface: "#FFF8E8",
      surfaceSoft: "#FFEBC2",
      surfaceStrong: "#FFD500",
      text: "#111111",
      textMuted: "#4B362D",
      primary: "#EF233C",
      primarySoft: "#FFD1D6",
  ...
  makeTheme({
    ...
    tokens: {
      background: "#12103A",
      backgroundAlt: "#2E1B7A",
      surface: "rgba(255,255,255,0.14)",
      surfaceSoft: "rgba(255,255,255,0.09)",
      surfaceStrong: "rgba(255,255,255,0.22)",
      text: "#F8FAFF",
      textMuted: "#C9D4FF",
      primary: "#38BDF8",
      primarySoft: "rgba(56,189,248,.20)",
      secondary: "#A855F7",
      accent: "#F472B6",
      accent2: "#22D3EE",
      success: "#34D399",
...
export const getThemeChartColors = (theme: AppTheme) =>
  theme.charts.tremorPalette;
export const resolveTheme = (id?: string) =>
  themeById[id as ThemeId] ?? themeById[defaultThemeId];
