...
export const comicBookEnergyTheme = defineTheme({
  ...
  identity: { typography: "comic-display", frame: "comic", navigation: { variant: "comic", compactLabels: false, showDecorativeStatus: false }, cells: { variant: "comic-token" } },
  charts: createCharts({
    hexPalette: ["#EF233C", "#FFD500", "#0077FF", "#06D6A0", "#FF7A00"],
    status: { done: "#06D6A0", partial: "#FFD500", missed: "#EF233C", rest: "#0077FF", empty: "#F2D6B8" },
    visual: { strokeWidth: 14, cornerRadius: 10, grid: "comic", donutVariant: "comic", barVariant: "comic", heatmapVariant: "comic-badges" },
  }),
  radius: { card: "16px", button: "12px", pill: "999px" },
  effects: { backgroundStyle: "comic", glass: false, glow: false, pattern: true, stickers: false, highContrast: true, pixel: false, comic: true },
});
