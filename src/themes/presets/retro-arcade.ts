...
export const retroArcadeTheme = defineTheme({
  ...
  identity: { typography: "pixel", navigation: { status: "arcade" }, cells: { variant: "pixel-tile" } },
  charts: createCharts({
    hexPalette: ["#FF2BD6", "#00F5D4", "#FEE440", "#9B5DE5", "#00FF85"],
    status: { done: "#00FF85", partial: "#FEE440", missed: "#FF3864", rest: "#00F5D4", empty: "#3B1680" },
    visual: { strokeWidth: 10, cornerRadius: 2, grid: "pixel", donutVariant: "pixel", barVariant: "pixel" },
  }),
  radius: { card: "10px", button: "6px", pill: "4px" },
  effects: { backgroundStyle: "arcade", pixel: true },
});
