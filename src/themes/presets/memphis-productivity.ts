...
export const memphisProductivityTheme = defineTheme({
  ...
  identity: { typography: "bold-geometric", frame: "memphis", navigation: { variant: "color-block", compactLabels: false, showDecorativeStatus: false }, cells: { variant: "memphis-shape" } },
  charts: createCharts({
    hexPalette: ["#FF3B30", "#FFD60A", "#0A84FF", "#34C759", "#FF9F0A"],
    status: { done: "#34C759", partial: "#FFD60A", missed: "#FF2D55", rest: "#0A84FF", empty: "#D7D2C6" },
    visual: { strokeWidth: 13, cornerRadius: 4, grid: "comic", donutVariant: "solid", barVariant: "comic", heatmapVariant: "memphis-shapes" },
  }),
  radius: { card: "18px", button: "8px", pill: "999px" },
  effects: { backgroundStyle: "memphis", glass: false, glow: false, pattern: true, stickers: false, highContrast: true, pixel: false, comic: false },
});
