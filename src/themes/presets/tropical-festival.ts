...
export const tropicalFestivalTheme = defineTheme({
  ...
  identity: { typography: "organic", frame: "botanical", navigation: { variant: "botanical", compactLabels: false, showDecorativeStatus: false }, cells: { variant: "tropical-seed" } },
  charts: createCharts({
    hexPalette: ["#087F5B", "#FFB703", "#F97316", "#2EC4B6", "#7BC950"],
    status: { done: "#2F9E44", partial: "#FFD43B", missed: "#FF6B6B", rest: "#2EC4B6", empty: "#D9E8BC" },
    visual: { strokeWidth: 14, cornerRadius: 18, grid: "soft", donutVariant: "soft", barVariant: "rounded", heatmapVariant: "tropical-seeds" },
  }),
  radius: { card: "28px", button: "999px", pill: "999px" },
  effects: { backgroundStyle: "tropical", glass: false, glow: false, pattern: true, stickers: true, highContrast: false, pixel: false, comic: false },
});
