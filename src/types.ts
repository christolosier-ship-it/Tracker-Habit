...
export type HabitLog={habitId:string;date:string;status:HabitStatus}; export type UserSettings={anneeActive:number;moisActif:number;compterNonSaisisCommeManques:boolean};
